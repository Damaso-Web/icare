    ...
    <template v-else>
      ...
      <div style="display:grid;grid-template-columns:1fr 340px;gap:16px">
        ...
        <div style="display:flex;flex-direction:column;gap:16px">
          ...
          <div class="icard">
            <div class="icard-header" style="display:flex;align-items:center;justify-content:space-between">
              ...
              <!-- Amending or archiving a referral is a Referral Queue action.
                   Case Files reads the referral as case history only. -->
              <div v-if="!fromCases" style="display:flex;gap:6px">
          ...
          <div class="icard">
            ...
            <div style="padding:10px 18px;border-bottom:1px solid var(--cloud);display:flex;justify-content:space-between;align-items:center;background:var(--snow)">
              ...
              <div style="font-size:11px;color:var(--stone);text-align:right">
                <div><strong>Effectivity:</strong> 07/04/23</div>
                <div v-if="isGCU" style="display:flex;align-items:center;gap:4px;justify-content:flex-end">
                  <strong>Ctrl No.:</strong>
                  <!-- TODO: restrict this input to the super_admin role once it exists (teammate is implementing it separately) -->
                  <input v-model="feedbackForm.feedback_ctrl_no" type="text" style="width:70px;font-size:11px;padding:1px 4px;border:1px solid var(--cloud);border-radius:3px" placeholder="26-1"/>
                </div>
                <div v-else><strong>Ctrl No.:</strong> {{ referral.feedback_ctrl_no || '-' }}</div>
              </div>
            </div>
        ...
        <div style="display:flex;flex-direction:column;gap:16px">
          ...
          <!-- Service Slips - issuing slips is a live referral action, not part
               of reading a case file, so the panel is hidden in Case Files. -->
